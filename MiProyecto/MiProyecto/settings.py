...
SECRET_KEY = 'django-insecure-cl2bamds2fcfbp65^mgq*-f_qiid&gmxym%wnvan#p)2(@@qpf'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['C:/Users/freddygpa/PycharmProjects/django/MiProyecto/MiProyecto/plantillas'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
